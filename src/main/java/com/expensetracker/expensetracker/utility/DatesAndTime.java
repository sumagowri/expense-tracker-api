...
public class DatesAndTime {
	...
	public List<Integer> getThreeMonths(int month){
	...
	public List<Date> getInDateFormat(String year,List<Integer> NoDaysAndMonth) {
		// set in yyyy-mm-dd in string monYear.get(1)
		String fromDate = year + "-" + String.format("%02d",NoDaysAndMonth.get(1)) + "-01";
		String toDate = year + "-" + String.format("%02d",NoDaysAndMonth.get(1)) + "-" + NoDaysAndMonth.get(0);
